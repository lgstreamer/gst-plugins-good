...
#define GST_AVI_DEMUX_MAX_STREAMS       32
#define CHUNKID_TO_STREAMNR(chunkid) \
  ((((chunkid) & 0xff) - '0') * 10 + \
   (((chunkid) >> 8) & 0xff) - '0')
#define AVI_PUSHMODE_TRICK
...
typedef struct _GstAviDemux
{
  ...
  guint64 video_position;
  guint64 prev_video_position;
  guint prev_keyframe_index;
